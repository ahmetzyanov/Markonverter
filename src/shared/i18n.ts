...
const RU_MESSAGES = {
  ...
  optionsInlineConvertedPricesLabel: "Пересчитанная цена рядом с ценой",
  optionsInlineConvertedPricesHint: "Показывать пересчитанную цену рядом с ценами в другой валюте",
...
const EN_MESSAGES: Record<I18nKey, string> = {
  ...
  optionsInlineConvertedPricesLabel: "Inline converted prices",
  optionsInlineConvertedPricesHint: "Show converted price next to prices in another currency",
